...
class TdcAccess:
	...
	#print "***** init HR2"
        ...
        asi.setInt('EN_DOUT_OC',1)
        asi.setInt('ON_OFF_OTAQ',0)
        asi.setInt('DIS_RAZCHN_EXT',1)
        asi.setInt('EN_BIAS_DAC_DELAY',1)
        ...
        asi.setInt('EN_BIAS_DISCRI_ADC_CHARGE',1)
        ...
        asi.setInt('EN_BIAS_RAMP_DELAY',1)
        ...
        asi.setInt('EN_DISCRI_DELAY',1)
        asi.setInt('LATCH',0)
        asi.setInt('EN_BIAS_DISCRI_ADC_TIME',1)
        asi.setInt('EN_NOR32_TIME',1)
        asi.setInt('EN_TEMP_SENSOR',1)
        asi.setInt('PP_BIAS_PA',0)
        asi.setInt('PP_ADC',0)
        asi.setInt('PP_BIAS_DISCRI',0)
        asi.setInt('VTHTIME',410)
        asi.setInt('SEL_80M',0)
        asi.setInt('EN_BIAS_TDC',1)
