...
class Ui_DaqWindow(object):
    def setupUi(self, DaqWindow):
        ...
        font.setBold(True)
        font.setWeight(75)
        self.lcdRUN.setFont(font)
        self.lcdRUN.setDigitCount(8)
        self.lcdRUN.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.lcdEvent.setFont(font)
        self.lcdEvent.setDigitCount(9)
        self.lcdEvent.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
