...
lydaq::DIFReadout::DIFReadout (std::string name,uint32_t productid) : FtdiDIFDriver ((char*) name.c_str(),productid),theName_(name),theAsicType_(2),theNumberOfAsics_(48),theControlRegister_(0x80181B00),	theCurrentSLCStatus_(0),
...
lydaq::DIFReadout::~DIFReadout()
{
  printf("%s %d \n",__PRETTY_FUNCTION__,__LINE__);
}
void lydaq::DIFReadout::setPowerManagment(uint32_t P2PAReg, uint32_t PA2PDReg,uint32_t PD2DAQReg, uint32_t DAQ2DReg,uint32_t D2AReg)
{
...
void lydaq::DIFReadout::setAsicType(uint32_t asicType)
{
  theAsicType_=asicType;
}
void lydaq::DIFReadout::setNumberOfAsics(uint32_t NumberOfAsics)
{
  theNumberOfAsics_=NumberOfAsics;
}

void lydaq::DIFReadout::setControlRegister(uint32_t ControlRegister)
{
  theControlRegister_=ControlRegister;
}


void lydaq::DIFReadout::initialise(uint32_t difid,uint32_t asicType,uint32_t NumberOfAsics,uint32_t ctrlreg,uint32_t P2PAReg, uint32_t PA2PDReg,uint32_t PD2DAQReg, uint32_t DAQ2DReg,uint32_t D2AReg)
{
...
void lydaq::DIFReadout::start()
{
  // Nothing to do yet
  LOG4CXX_INFO(_logDIF,"Start");
  HardrocFlushDigitalFIFO();	
}
void lydaq::DIFReadout::stop()
{
...
void lydaq::DIFReadout::DoRefreshNbOfASICs()
{
...
int32_t lydaq::DIFReadout::DoReadSLCStatus()
{	
...
void lydaq::DIFReadout::configureRegisters()
{
...
void lydaq::DIFReadout::DoSendDIFTemperatureCommand()
{
...
void lydaq::DIFReadout::DoSendASUTemperatureCommand()
{
...
void lydaq::DIFReadout::DoGetASUTemperatureCommand(uint32_t *ttemp1,uint32_t *ttemp2)
{
...
void lydaq::DIFReadout::DoGetDIFTemperatureCommand(uint32_t *ttemp)
{
...
void lydaq::DIFReadout::DoSetTemperatureReadoutToAuto(uint32_t tvalue)
{
  uint32_t ttemp;
...
void lydaq::DIFReadout::DoGetTemperatureReadoutAutoStatus(uint32_t *tvalue)
{
  uint32_t ttemp;
...
void lydaq::DIFReadout::DoSetEventsBetweenTemperatureReadout(uint32_t tvalue)
{
  uint32_t ttemp;
  //	std::cout<<"Usb do set dif temperature mode "<<tvalue<<std::endl;
...
void lydaq::DIFReadout::DoSetAnalogConfigureRegister(uint32_t tdata)    
{
  uint32_t ttemp;
  //	std::cout<<"Usb do set dif temperature mode "<<tvalue<<std::endl;
...
uint32_t lydaq::DIFReadout::DoHardrocV2ReadoutDigitalData(unsigned char* CurrentDIFDigitalData)
{
